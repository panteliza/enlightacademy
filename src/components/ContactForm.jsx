    ...
    <div className="flex flex-col items-center justify-center py-10 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          ...
          <p className="text-center text-gray-700">Putalisadak near Shankardev College, Kathmandu, Nepal</p>
        </div>
        ...
        >
          <FaPhoneAlt className="text-[#038A58] text-4xl mb-4 shiver-icon transition duration-300 hover:text-red-800" />
          <h3 className="font-bold sm:text-[20px] text-[18px] text-gray-800 mb-2">
            Our Contact
          </h3>
          <p className="text-center text-gray-700">977 9809494619</p>
        </div>
        ...
        >
          <FaEnvelope className="text-[#038A58] text-4xl mb-4 shiver-icon transition duration-300 hover:text-red-800" />
          <h3 className="font-bold sm:text-[20px] text-[18px] text-gray-800 mb-2">
            Mail Us
          </h3>
          <p className="text-center text-gray-700">enlightskill2073@gmail.com</p>
        </div>
      </div>
